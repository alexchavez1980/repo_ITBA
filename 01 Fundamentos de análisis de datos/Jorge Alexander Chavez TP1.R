...
file.choose()
ruta_FAD_TP1<-"D:\\Alex\\Estudio\\Esp Ciencia de Datos\\01 Fundamentos de análisis de datos\\FAD_TP1.csv"

#-----------------------------------------------------
#Punto 1a
#Lectura/Carga y almacentamiento del dataset en dataset_FAD_TP1
#-----------------------------------------------------
dataset_FAD_TP1<-read.csv2(ruta_FAD_TP1)
#-----------------------------------------------------
#Punto 1b
